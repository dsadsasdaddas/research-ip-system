...
import type { CopyrightsService } from './copyrights.service';
...
describe('CopyrightsController', () => {
  let controller: CopyrightsController;
  let service: MockObject;

  beforeEach(() => {
    service = mockService();
    controller = new CopyrightsController(
      service as unknown as CopyrightsService,
    );
  });
