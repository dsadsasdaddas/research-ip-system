...
export class ReportTemplate {
  ...
  @Column({ type: 'varchar', name: 'report_type', length: 50, comment: '报表类型: paper/patent/fee/transform/custom' })
  reportType!: string;

  @Column({ type: 'text', name: 'config_json', nullable: true, comment: '报表配置JSON' })
  configJson!: string | null;

  @Column({ type: 'varchar', length: 50, default: 'dept', comment: '作用域: personal/dept/all' })
  scope!: string;
